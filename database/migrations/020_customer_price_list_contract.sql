...
-- Legacy environments may already have price_lists without the current active column.
-- Keep this migration additive so the canonical index below is safe on those databases.
